...
class GetAllReservationModel {
  Data? data;
  GetAllReservationModel({this.data});

  factory GetAllReservationModel.fromJson(Map<String, dynamic> json) {
    return GetAllReservationModel(data: Data.fromJson(json['data']));
  }
}
...
class Reservation {
  ...
  factory Reservation.fromJson(Map<String, dynamic> json) {
    var list =
        json['rows'] as List<dynamic>?; // Explicitly cast to List<dynamic>
    List<Rows>? rowList;
    if (list != null) {
      rowList = list.map((i) => Rows.fromJson(i)).toList().cast<Rows>();
    }
